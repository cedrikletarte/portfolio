  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center'>
         <form method='POST' action='https://getform.io/f/933db683-e35f-4f49-964f-d25ca92b8846' className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className='bg-[#ccd6f6] p-2' type='text' placeholder={t('contact.name')} name='name' required/>
            <input className='my-4 p-2 bg-[#ccd6f6]' type='text' pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title={t('contact.emailTitle')} placeholder={t('contact.email')} name='email' required/>
            <textarea className='bg-[#ccd6f6] p-2' name='message' rows={6} placeholder={t('contact.message')} required />
